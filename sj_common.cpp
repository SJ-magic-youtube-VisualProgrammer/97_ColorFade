...
void GUI_GLOBAL::setup(string GuiName, string FileName, float x, float y)
{
	...
	********************/
	...
	/********************
	********************/
	Group_ColorFade.setup("ColorFade");
		Group_ColorFade.add(ColorFade__dt_HchangeFull.setup("dt_HchangeFull", 3.0, 0.5, 10.0));
		Group_ColorFade.add(ColorFade__H.setup("H", 0.0, 0.0, 1.0));
		Group_ColorFade.add(ColorFade__S.setup("S", 1.0, 0.0, 1.0));
		Group_ColorFade.add(ColorFade__V.setup("V", 1.0, 0.0, 1.0));
		Group_ColorFade.add(ColorFade__Button_StartFade.setup("Button_StartFade", false));
	gui.add(&Group_ColorFade);
